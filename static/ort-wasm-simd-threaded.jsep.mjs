var ortWasmThreaded = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    if (D) {
      ...
      E = (C = !ra.qc) && "em-pthread" == ra.workerData;
    }
    ("use strict");
    ...
    let ta = () => {
      const a =
        ...
        b =
          ...
          async (...d) => {
            try {
              if (B.Gb) throw Error("Session already started");
              const f = (B.Gb = { hc: d[0], errors: [] }),
                g = await c(...d);
              if (B.Gb !== f) throw Error("Session mismatch");
              B.Hb?.flush();
              const k = f.errors;
              if (0 < k.length) {
    ...
    B.jsepInit = (a, b) => {
      ta?.();
      if ("webgpu" === a) {
        [B.Hb, B.Vb, B.Zb, B.Ob, B.Yb, B.kb, B.$b, B.cc, B.Wb, B.Xb, B.ac] = b;
        const c = B.Hb;
        ...
        [B.Hb, B.bc, B.Pb, B.jsepEnsureTensor, B.ec, B.jsepDownloadTensor] = b;
        B.jsepReleaseTensorId = B.Pb;
        const c = B.Hb;
        B.jsepOnRunStart = (d) => c.onRunStart(d);
        ...
        B.jsepCreateMLTensorDownloader = (d, f) =>
          c.createMLTensorDownloader(d, f);
        B.jsepRegisterMLTensor = (d, f, g) => c.registerMLTensor(d, f, g);
        B.jsepCreateMLContext = (d) => c.createMLContext(d);
        B.jsepRegisterMLConstant = (d, f, g, k, m) =>
          c.registerMLConstant(d, f, g, k, m, B.Fb);
      }
    };
    ...
    if (E) {
      ...
      self.alert = function (...b) {
        postMessage({ Nb: "alert", text: b.join(" "), rc: Ia() });
      };
        ...
        try {
          ...
          if ("load" === d) {
            ...
            for (const g of c.handlers)
              if (!B[g] || B[g].proxy)
                (B[g] = (...k) => {
                  postMessage({ Nb: "callHandler", pc: g, args: k });
                }),
                  "print" == g && (Ea = B[g]),
                  "printErr" == g && (H = B[g]);
            l = c.wasmMemory;
    ...
    var db = (a) => a.startsWith("data:application/octet-stream;base64,"),
      ...
      eb;
    function fb(a) {
      if (a == eb && Ta) return new Uint8Array(Ta);
      if (za) return za(a);
    ...
    var Lc = {
      ...
      917841: (a) => B.Zb(a),
      917873: (a, b, c) => {
        B.Ob(Number(a), Number(b), Number(c), !0);
      },
      917936: (a, b, c) => {
        B.Ob(Number(a), Number(b), Number(c));
      },
      917993: () => "undefined" !== typeof wasmOffsetConverter,
      918050: (a) => {
        B.kb("Abs", a, void 0);
      },
      918101: (a) => {
      ...
      918524: (a, b, c) => {
        B.kb("HardSigmoid", a, { alpha: b, beta: c });
      },
      918603: (a) => {
        B.kb("Log", a, void 0);
      },
      ...
      919612: (a, b) => {
        B.kb("LeakyRelu", a, { alpha: b });
      },
      919676: (a, b) => {
        B.kb("ThresholdedRelu", a, { alpha: b });
      },
      919746: (a, b) => {
        B.kb("Cast", a, { to: b });
      },
      ...
      920112: (a) => {
        B.kb("Greater", a, void 0);
      },
      920167: (a) => {
        B.kb("GreaterOrEqual", a, void 0);
      },
      920229: (a) => {
        B.kb("Less", a, void 0);
      },
      920281: (a) => {
        B.kb("LessOrEqual", a, void 0);
      },
      920340: (a, b, c, d, f) => {
        B.kb("ReduceMean", a, {
          keepDims: !!b,
          noopWithEmptyAxes: !!c,
          axes: d
            ? Array.from(z().subarray(Number(d) >>> 0, Number(f) >>> 0))
            : [],
        });
      },
      920515: (a, b, c, d, f) => {
      ...
      922148: (a, b, c) => {
        B.kb("Transpose", a, {
          perm: b
            ? Array.from(z().subarray(Number(b) >>> 0, Number(c) >>> 0))
            : [],
        });
      },
      922272: (a, b, c, d) => {
      ...
      922538: (a, b, c, d, f, g, k, m, p, n, r, v, x, h, u) => {
        B.kb("ConvTranspose", a, {
          format: p ? "NHWC" : "NCHW",
          autoPad: b,
          dilations: [c],
          group: d,
          ...
          wIsConst: () => !!e()[n >>> 0],
          outputPadding: r
            ? Array.from(z().subarray(Number(r) >>> 0, Number(v) >>> 0))
            : [],
          outputShape: x
            ? Array.from(z().subarray(Number(x) >>> 0, Number(h) >>> 0))
            : [],
          activation: L(u),
        });
      },
      922971: (a, b, c, d, f, g, k, m, p, n, r, v, x, h) => {
        B.kb("ConvTranspose", a, {
          format: m ? "NHWC" : "NCHW",
          autoPad: b,
          dilations: Array.from(
            z().subarray(Number(c) >>> 0, ((Number(c) >>> 0) + 2) >>> 0),
          ),
          group: d,
          kernelShape: Array.from(
            z().subarray(Number(f) >>> 0, ((Number(f) >>> 0) + 2) >>> 0),
          ),
          pads: Array.from(
            z().subarray(Number(g) >>> 0, ((Number(g) >>> 0) + 4) >>> 0),
          ),
          strides: Array.from(
            z().subarray(Number(k) >>> 0, ((Number(k) >>> 0) + 2) >>> 0),
          ),
          wIsConst: () => !!e()[p >>> 0],
          outputPadding: n
            ? Array.from(z().subarray(Number(n) >>> 0, Number(r) >>> 0))
            : [],
          outputShape: v
            ? Array.from(z().subarray(Number(v) >>> 0, Number(x) >>> 0))
            : [],
          activation: L(h),
        });
      },
      923632: (a, b, c, d, f, g, k, m, p, n, r, v, x, h, u) => {
        B.kb("ConvTranspose", a, {
          format: p ? "NHWC" : "NCHW",
          autoPad: b,
          dilations: [c],
      ...
      924065: (a, b, c, d, f, g, k, m, p, n, r, v, x, h) => {
        B.kb("ConvTranspose", a, {
          format: m ? "NHWC" : "NCHW",
          autoPad: b,
          dilations: Array.from(
      ...
      924726: (a, b) => {
        B.kb("GlobalAveragePool", a, { format: b ? "NHWC" : "NCHW" });
      },
      924817: (a, b, c, d, f, g, k, m, p, n, r, v, x, h) => {
        B.kb("AveragePool", a, {
          format: h ? "NHWC" : "NCHW",
          auto_pad: b,
          ceil_mode: c,
          ...
          storage_order: f,
          dilations: g
            ? Array.from(z().subarray(Number(g) >>> 0, Number(k) >>> 0))
            : [],
          kernel_shape: m
            ? Array.from(z().subarray(Number(m) >>> 0, Number(p) >>> 0))
            : [],
          pads: n
            ? Array.from(z().subarray(Number(n) >>> 0, Number(r) >>> 0))
            : [],
      ...
      925387: (a, b, c, d, f, g, k, m, p, n, r, v, x, h) => {
        B.kb("AveragePool", a, {
          format: h ? "NHWC" : "NCHW",
          auto_pad: b,
          ceil_mode: c,
      ...
      925866: (a, b) => {
        B.kb("GlobalMaxPool", a, { format: b ? "NHWC" : "NCHW" });
      },
      925953: (a, b, c, d, f, g, k, m, p, n, r, v, x, h) => {
        B.kb("MaxPool", a, {
          format: h ? "NHWC" : "NCHW",
          auto_pad: b,
          ceil_mode: c,
      ...
      926515: (a, b, c, d, f, g, k, m, p, n, r, v, x, h) => {
        B.kb("MaxPool", a, {
          format: h ? "NHWC" : "NCHW",
          auto_pad: b,
          ceil_mode: c,
      ...
      926990: (a, b, c, d, f) => {
        B.kb("Gemm", a, { alpha: b, beta: c, transA: d, transB: f });
      },
      927094: (a) => {
        B.kb("MatMul", a, void 0);
      },
      927148: (a, b, c, d) => {
        B.kb("ArgMax", a, { keepDims: !!b, selectLastIndex: !!c, axis: d });
      },
      927256: (a, b, c, d) => {
        B.kb("ArgMin", a, { keepDims: !!b, selectLastIndex: !!c, axis: d });
      },
      927364: (a, b) => {
        B.kb("Softmax", a, { axis: b });
      },
      927427: (a, b) => {
        B.kb("Concat", a, { axis: b });
      },
      927487: (a, b, c, d, f) => {
        B.kb("Split", a, {
          axis: b,
      ...
      927643: (a) => {
        B.kb("Expand", a, void 0);
      },
      927697: (a, b) => {
        B.kb("Gather", a, { axis: Number(b) });
      },
      927768: (a, b) => {
        B.kb("GatherElements", a, { axis: Number(b) });
      },
      927847: (a, b) => {
        B.kb("GatherND", a, { batch_dims: Number(b) });
      },
      927926: (a, b, c, d, f, g, k, m, p, n, r) => {
        B.kb("Resize", a, {
          antialias: b,
          axes: c
            ? Array.from(z().subarray(Number(c) >>> 0, Number(d) >>> 0))
            : [],
          coordinateTransformMode: L(f),
          cubicCoeffA: g,
          excludeOutside: k,
          extrapolationValue: m,
          keepAspectRatioPolicy: L(p),
          mode: L(n),
          nearestMode: L(r),
        });
      },
      928288: (a, b, c, d, f, g, k) => {
        B.kb("Slice", a, {
          starts: b
            ? Array.from(z().subarray(Number(b) >>> 0, Number(c) >>> 0))
            : [],
      ...
      929447: (a, b, c) => {
        B.kb("CumSum", a, { exclusive: Number(b), reverse: Number(c) });
      },
      929544: (a, b, c) => {
        B.kb("DequantizeLinear", a, { axis: b, blockSize: c });
      },
      929634: (a, b, c, d, f) => {
        B.kb("GridSample", a, {
          align_corners: b,
      ...
      930246: (a) => {
        B.kb("BiasAdd", a, void 0);
      },
      930301: (a) => {
        B.kb("BiasSplitGelu", a, void 0);
      },
      930362: (a) => {
        B.kb("FastGelu", a, void 0);
      },
      930418: (a, b, c, d, f, g, k, m, p, n, r, v, x, h, u, y) => {
        B.kb("Conv", a, {
          format: v ? "NHWC" : "NCHW",
          auto_pad: b,
          dilations: c
          ...
          strides: n
            ? Array.from(z().subarray(Number(n) >>> 0, Number(r) >>> 0))
            : [],
          w_is_const: () => !!e()[Number(x) >>> 0],
          activation: L(h),
          activation_params: u
            ? Array.from(ja().subarray(Number(u) >>> 0, Number(y) >>> 0))
            : [],
        });
      },
      931002: (a) => {
      ...
      931054: (a, b, c, d, f, g, k, m, p) => {
        B.kb("GroupQueryAttention", a, {
          numHeads: b,
          kvNumHeads: c,
          scale: d,
          softcap: f,
      ...
      931271: (a, b, c, d) => {
        B.kb("LayerNormalization", a, { axis: b, epsilon: c, simplified: !!d });
      },
      931382: (a, b, c, d) => {
        B.kb("LayerNormalization", a, { axis: b, epsilon: c, simplified: !!d });
      },
      ...
      931779: (a, b) => {
        B.kb("QuickGelu", a, { alpha: b });
      },
      931843: (a, b, c, d, f) => {
        B.kb("RotaryEmbedding", a, {
          interleaved: !!b,
          numHeads: c,
      ...
      931982: (a, b, c) => {
        B.kb("SkipLayerNormalization", a, { epsilon: b, simplified: !!c });
      },
      932084: (a, b, c) => {
        B.kb("SkipLayerNormalization", a, { epsilon: b, simplified: !!c });
      },
      932186: (a, b, c, d) => {
        B.kb("GatherBlockQuantized", a, {
          gatherAxis: b,
          quantizeAxis: c,
          blockSize: d,
        });
      ...
      932341: (a, b) => B.cc(Number(a), Number(b), B.Gb.hc, B.Gb.errors),
    };
    function lb(a, b, c) {
      return Mc(async () => {
        await B.Yb(Number(a), Number(b), Number(c));
      });
    }
    function kb() {
    ...
    var Oc = (a) => {
      ...
      Rc = (a) => {
        ...
        D && b.unref();
        b.postMessage(c, a.nc);
        return 0;
      },
      Sc = 0,
      P = (a, b, ...c) => {
        for (
          var d = 2 * c.length, f = Tc(), g = Vc(8 * d), k = g >>> 3, m = 0;
          m < c.length;
          m++
        ) {
          var p = c[m];
    ...
    var Qc = (a) =>
      new Promise((b) => {
        a.onmessage = (g) => {
          ...
          if (g.targetThread && g.targetThread != Ia()) {
          ...
          else if ("cleanupThread" === k) cd(O[g.thread]);
            ...
            (g = g.thread),
              ...
              Oc(k),
              bd(g),
              N.splice(N.indexOf(k), 1),
              (k.Bb = 0);
          else if ("cancelThread" === k)
            O[g.thread].postMessage({ cmd: "cancel" });
          else if ("loaded" === k)
            (a.loaded = !0), D && !a.Bb && a.unref(), b(a);
    ...
    function ad(a) {
      E ? a() : Promise.all(M.map(Qc)).then(a);
    }
    function Pc() {
    ...
    function kd(a, b, c, d) {
      return E ? P(2, 1, a, b, c, d) : nb(a, b, c, d);
    }
    function nb(a, b, c, d) {
      a >>>= 0;
      b >>>= 0;
      ...
      var f = [];
      if (E && 0 === f.length) return kd(a, b, c, d);
      a = { ic: c, Bb: a, Rb: d, nc: f };
      return E ? ((a.Nb = "spawnThread"), postMessage(a, f), 0) : Rc(a);
    }
    var ld =
    ...
    function ud(a, b, c = {}) {
      ...
      delete td[a];
      rd.hasOwnProperty(a) &&
        ((b = rd[a]), delete rd[a], b.forEach((f) => f()));
    }
    function S(a, b, c = {}) {
    ...
    function Cb(a, b, c) {
      ...
      S(a, {
        ...
        argPackAdvance: T,
        readValueFromPointer: vd(b, c, -1 == b.indexOf("u")),
        Eb: null,
      });
    }
    var T = 8;
    ...
    function Wb(a) {
      a >>>= 0;
      9 < a && 0 === --U[a + 1] && ((U[a] = void 0), wd.push(a));
    }
    var V = (a) => {
    ...
    function Gb(a, b, c, d, f) {
      ...
      S(a, {
        ...
        toWireType: k,
        argPackAdvance: T,
        readValueFromPointer: vd(b, c, 0 !== d),
        Eb: null,
      });
    }
    function Hb(a, b, c) {
      ...
      S(a, {
        ...
        fromWireType: function (d) {
          ...
          if (c)
            ...
            n = Array(f);
            for (m = 0; m < f; ++m)
              n[m] = String.fromCharCode(w()[(g + m) >>> 0]);
            n = n.join("");
          }
          X(d);
          return n;
    ...
    var Bd =
      ...
      Cd = (a, b) => {
        ...
        c <<= 1;
        if (32 < c - a && Bd) return Bd.decode(w().slice(a, c));
        c = "";
        for (d = 0; !(d >= b / 2); ++d) {
          var f = ca()[((a + 2 * d) >>> 1) >>> 0];
          if (0 == f) break;
    ...
    function La(a) {
      a >>>= 0;
      "function" === typeof Atomics.oc &&
        (Atomics.oc(z(), a >>> 2, a).value.then(Ra),
        (a += 128),
    ...
    function Nb(a, b) {
      ...
      a == b >>> 0
        ...
        : E
          ...
          : (a = O[a]) && a.postMessage({ cmd: "checkMailbox" });
    }
    var Kd = [];
    function Ob(a, b, c, d, f) {
      ...
      c = (f >>> 0) >>> 3;
      for (f = 0; f < d; f++)
        Kd[f] = J[c + 2 * f] ? J[c + 2 * f + 1] : la()[(c + 2 * f + 1) >>> 0];
      return (b ? Lc[b] : Ld[a])(...Kd);
    }
    function Pb(a) {
      a >>>= 0;
      E ? postMessage({ cmd: "cleanupThread", thread: a }) : cd(O[a]);
    }
    function Qb(a) {
      D && O[a >>> 0].ref();
    }
    var Nd = (a, b) => {
        ...
        if (void 0 === c)
          throw (
            ((a = Md(a)), (c = Q(a)), X(a), new R(`${b} has unknown type ${c}`))
          );
        return c;
      },
      Od = (a, b, c) => {
                ...
                try {
                  ...
                  I ||
                    ...
                    F &&
                      ...
                      (Sc += 1),
                      Pd(Sd),
                      "undefined" != typeof Fibers && Fibers.tc()));
                }
              }
            : d;
      return b;
        ...
        if (0 === Z) {
          ...
          a((d = 0) => {
            if (!I && ((Td = d), (b = !0), c)) {
              ...
              if (!F) {
                var k = Xd;
                k && ((Xd = null), (d ? k.reject : k.resolve)(f), (g = !0));
              }
              if (d && !g) throw f;
            }
          });
          ...
          2 === Z
            ? ((Z = 0), Pd(de), X(F), (F = null), Yd.forEach(Id))
            : K(`invalid state: ${Z}`);
        return Td;
      }
    }
    ...
    var ie = (a) => {
      ...
      je = (a, b) => {
        for (var c = Array(a), d = 0; d < a; ++d)
          c[d] = Nd(A()[((b + 4 * d) >>> 2) >>> 0], "parameter " + d);
        return c;
      },
      ke = (a, b) => Object.defineProperty(b, "name", { value: a });
    function le(a) {
      var b = Function;
      ...
      var c = ke(b.name || "unknownFunctionName", function () {});
    ...
    var me = (a) => 0 === a % 4 && (0 !== a % 100 || 0 === a % 400),
      ne = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
      oe = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
    function jc(a, b) {
      a = -9007199254740992 > a || 9007199254740992 < a ? NaN : Number(a);
      b >>>= 0;
      a = new Date(1e3 * a);
      ...
      z()[((b + 24) >>> 2) >>> 0] = a.getDay();
      var c =
        ((me(a.getFullYear()) ? ne : oe)[a.getMonth()] + a.getDate() - 1) | 0;
      z()[((b + 28) >>> 2) >>> 0] = c;
    ...
    function kc(a) {
      ...
      z()[((a + 24) >>> 2) >>> 0] = b.getDay();
      c = ((me(b.getFullYear()) ? ne : oe)[b.getMonth()] + b.getDate() - 1) | 0;
      z()[((a + 28) >>> 2) >>> 0] = c;
    ...
    function nc(a, b, c, d) {
      ...
      g = a(g);
      k = a(k);
      m < f ? (pd(g, c, 17), pd(k, d, 17)) : (pd(g, d, 17), pd(k, c, 17));
    }
    var pe = [],
      qe = (a, b) => {
        pe.length = 0;
    ...
    function Ac(a, b, c) {
      a >>>= 0;
      b >>>= 0;
      if (se.Qb == a) var d = se.fc;
      else
        (d = Error().stack.toString().split("\n")),
          "Error" == d[0] && d.shift(),
          te(d);
      for (var f = 3; d[f] && re() != a; ) ++f;
      for (a = 0; a < c && d[a + f]; ++a) z()[((b + 4 * a) >>> 2) >>> 0] = re();
      return a;
    }
    var ue = {},
      we = () => {
    ...
    var ye = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
    ...
    function Jc(a, b, c, d) {
      ...
      function k(h, u) {
        ...
        var ba;
        0 === (ba = y(h.getFullYear() - u.getFullYear())) &&
          0 === (ba = y(h.getMonth() - u.getMonth())) &&
          (ba = y(h.getDate() - u.getDate()));
        return ba;
      }
      function m(h) {
        switch (h.getDay()) {
      ...
      function p(h) {
        var u = h.Cb;
        for (h = new Date(new Date(h.Db + 1900, 0, 1).getTime()); 0 < u; ) {
          var y = h.getMonth(),
            ba = (me(h.getFullYear()) ? ye : ze)[y];
          if (u > ba - h.getDate())
            (u -= ba - h.getDate() + 1),
              h.setDate(1),
              11 > y
      ...
      n = {
        "%a": (h) => v[h.vb].substring(0, 3),
        "%A": (h) => v[h.vb],
        "%b": (h) => x[h.Jb].substring(0, 3),
        "%B": (h) => x[h.Jb],
        "%C": (h) => g(((h.Db + 1900) / 100) | 0, 2),
        "%d": (h) => g(h.Mb, 2),
        "%e": (h) => f(h.Mb, 2, " "),
        ...
        "%M": (h) => g(h.kc, 2),
        "%n": () => "\n",
        "%p": (h) => (0 <= h.Ib && 12 > h.Ib ? "AM" : "PM"),
        "%S": (h) => g(h.lc, 2),
        "%t": () => "\t",
        "%u": (h) => h.vb || 7,
        "%U": (h) => g(Math.floor((h.Cb + 7 - h.vb) / 7), 2),
        "%V": (h) => {
          var u = Math.floor((h.Cb + 7 - ((h.vb + 6) % 7)) / 7);
          2 >= (h.vb + 371 - h.Cb - 2) % 7 && u++;
          if (u)
            53 == u &&
              ((y = (h.vb + 371 - h.Cb) % 7),
              4 == y || (3 == y && me(h.Db)) || (u = 1));
            ...
            u = 52;
            var y = (h.vb + 7 - h.Cb - 1) % 7;
            (4 == y || (5 == y && me((h.Db % 400) - 1))) && u++;
          }
          return g(u, 2);
        },
        "%w": (h) => h.vb,
        "%W": (h) => g(Math.floor((h.Cb + 7 - ((h.vb + 6) % 7)) / 7), 2),
        "%y": (h) => (h.Db + 1900).toString().substring(2),
        "%Y": (h) => h.Db + 1900,
        "%z": (h) => {
          h = h.jc;
          var u = 0 <= h;
    ...
    E || $c();
    for (var Ce = Array(256), De = 0; 256 > De; ++De)
      Ce[De] = String.fromCharCode(De);
    qd = Ce;
    ...
    B.count_emval_handles = () => U.length / 2 - 5 - wd.length;
    var Ld = [
        Ic,
        Yc,
        kd,
      ...
      Md = (a) => (Md = Y.Da)(a),
      Oa = () => (Oa = Y.Ea)();
    B._OrtInit = (a, b) => (B._OrtInit = Y.Fa)(a, b);
    B._OrtGetLastError = (a, b) => (B._OrtGetLastError = Y.Ga)(a, b);
    B._OrtCreateSessionOptions = (a, b, c, d, f, g, k, m, p, n) =>
      (B._OrtCreateSessionOptions = Y.Ha)(a, b, c, d, f, g, k, m, p, n);
    B._OrtAppendExecutionProvider = (a, b) =>
      (B._OrtAppendExecutionProvider = Y.Ia)(a, b);
    B._OrtAddFreeDimensionOverride = (a, b, c) =>
      (B._OrtAddFreeDimensionOverride = Y.Ja)(a, b, c);
    B._OrtAddSessionConfigEntry = (a, b, c) =>
      (B._OrtAddSessionConfigEntry = Y.Ka)(a, b, c);
    B._OrtReleaseSessionOptions = (a) =>
      (B._OrtReleaseSessionOptions = Y.La)(a);
    B._OrtCreateSession = (a, b, c) => (B._OrtCreateSession = Y.Ma)(a, b, c);
    B._OrtReleaseSession = (a) => (B._OrtReleaseSession = Y.Na)(a);
    B._OrtGetInputOutputCount = (a, b, c) =>
      (B._OrtGetInputOutputCount = Y.Oa)(a, b, c);
    B._OrtGetInputName = (a, b) => (B._OrtGetInputName = Y.Pa)(a, b);
    B._OrtGetOutputName = (a, b) => (B._OrtGetOutputName = Y.Qa)(a, b);
    B._OrtFree = (a) => (B._OrtFree = Y.Ra)(a);
    B._OrtCreateTensor = (a, b, c, d, f, g) =>
      (B._OrtCreateTensor = Y.Sa)(a, b, c, d, f, g);
    B._OrtGetTensorData = (a, b, c, d, f) =>
      (B._OrtGetTensorData = Y.Ta)(a, b, c, d, f);
    B._OrtReleaseTensor = (a) => (B._OrtReleaseTensor = Y.Ua)(a);
    B._OrtCreateRunOptions = (a, b, c, d) =>
      (B._OrtCreateRunOptions = Y.Va)(a, b, c, d);
    B._OrtAddRunConfigEntry = (a, b, c) =>
      (B._OrtAddRunConfigEntry = Y.Wa)(a, b, c);
    B._OrtReleaseRunOptions = (a) => (B._OrtReleaseRunOptions = Y.Xa)(a);
    B._OrtCreateBinding = (a) => (B._OrtCreateBinding = Y.Ya)(a);
    B._OrtBindInput = (a, b, c) => (B._OrtBindInput = Y.Za)(a, b, c);
    B._OrtBindOutput = (a, b, c, d) => (B._OrtBindOutput = Y._a)(a, b, c, d);
    B._OrtClearBoundOutputs = (a) => (B._OrtClearBoundOutputs = Y.$a)(a);
    B._OrtReleaseBinding = (a) => (B._OrtReleaseBinding = Y.ab)(a);
    B._OrtRunWithBinding = (a, b, c, d, f) =>
      (B._OrtRunWithBinding = Y.bb)(a, b, c, d, f);
    B._OrtRun = (a, b, c, d, f, g, k, m) =>
      (B._OrtRun = Y.cb)(a, b, c, d, f, g, k, m);
    B._OrtEndProfiling = (a) => (B._OrtEndProfiling = Y.db)(a);
    B._JsepOutput = (a, b, c) => (B._JsepOutput = Y.eb)(a, b, c);
    B._JsepGetNodeName = (a) => (B._JsepGetNodeName = Y.fb)(a);
    var Ia = () => (Ia = Y.gb)(),
      X = (B._free = (a) => (X = B._free = Y.hb)(a)),
      Ad = (B._malloc = (a) => (Ad = B._malloc = Y.ib)(a)),
      Ka = (a, b, c, d, f, g) => (Ka = Y.lb)(a, b, c, d, f, g),
      Sa = () => (Sa = Y.mb)(),
      Wc = (a, b, c, d, f) => (Wc = Y.nb)(a, b, c, d, f),
      bd = (a) => (bd = Y.ob)(a),
      Qa = (a) => (Qa = Y.pb)(a),
      Jd = () => (Jd = Y.qb)(),
      ed = (a, b) => (ed = Y.rb)(a, b),
      ...
      Vc = (a) => (Vc = Y.tb)(a),
      Tc = () => (Tc = Y.ub)(),
      fd = (B.dynCall_ii = (a, b) => (fd = B.dynCall_ii = Y.wb)(a, b)),
      ce = (a) => (ce = Y.xb)(a),
      Sd = () => (Sd = Y.yb)(),
      be = (a) => (be = Y.zb)(a),
      de = () => (de = Y.Ab)();
    B.___start_em_js = 932469;
    B.___stop_em_js = 932715;
    function Ee() {
      var a = Y;
      a = Object.assign({}, a);
      var b = (d) => (f) => d(f) >>> 0,
    ...
    B.stackSave = () => Tc();
    B.stackRestore = (a) => Xc(a);
    B.stackAlloc = (a) => Vc(a);
    B.setValue = function (a, b, c = "i8") {
      c.endsWith("*") && (c = "*");
      switch (c) {
        case "i1":
          e()[a >>> 0] = b;
    ...
    function He() {
      0 < $a ||
        (E
          ? (na(B), E || dd(Ya), startWorker(B))
          : (dd(Xa),
            0 < $a ||
              Fe ||
              ((Fe = !0),
              (B.calledRun = !0),
              I || (E || dd(Ya), na(B), E || dd(Za)))));
    }
    He();
    ("use strict");
    B.PTR_SIZE = 4;
